...
## Requires a Scene Loader autoload.
@export var show_loading_screen : bool = false

## If a Scene Loader autoload is installed, then it will be used to change scenes.
...
func get_next_scene_path() -> String:
	return MenuUtils.get_main_menu_path(next_scene_path)
