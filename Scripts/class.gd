...
const PLUGIN_NAME = "The Light Keeper Menus"
const PROJECT_SETTINGS_PATH = "Scripts/"
...
static func set_project_paths(target_path : String, overwrite : bool = true) -> void:
	for key in SCENE_PATHS:
		...
		var stored_path : Variant = ProjectSettings.get_setting(PROJECT_SETTINGS_PATH + key)
